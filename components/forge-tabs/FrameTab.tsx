...
interface FrameTabProps {
  ...
  onApplyCompositionRule: (imageId: string, rule: 'center' | 'thirds' | 'golden') => void;
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-3 gap-2">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => {
                  onApplyCompositionRule(image.id, 'center');
                  onClose();
                }}
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => {
                  onApplyCompositionRule(image.id, 'thirds');
                  onClose();
                }}
                className="p-3 bg-white/5 border border-white/10 rounded-xl flex flex-col items-center gap-2 hover:bg-white/10 hover:border-white/20 transition-all group"
              >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => {
                  onApplyCompositionRule(image.id, 'golden');
                  onClose();
                }}
                className="p-3 bg-white/5 border border-white/10 rounded-xl flex flex-col items-center gap-2 hover:bg-white/10 hover:border-white/20 transition-all group"
              >
