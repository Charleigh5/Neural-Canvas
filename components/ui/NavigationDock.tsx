...
import { Grid, Play, Layers, Camera, Hexagon, LucideIcon } from 'lucide-react';
      ...
      <div className={positionClasses}>
        ...
        <div className="relative group p-1">
          <FrameLines
            ...
            style={
              {
                '--arwes-frames-line-color': '#6366f1',
                '--arwes-frames-bg-color': 'rgba(5, 5, 5, 0.8)',
              } as React.CSSProperties
            }
          />
          <div className="flex items-center backdrop-blur-2xl rounded-2xl p-1.5 pl-3 pr-2">
            <NavItem
        ...
        <div className="relative group p-1">
          <FrameLines
            ...
            style={
              {
                '--arwes-frames-line-color': '#ec4899',
                '--arwes-frames-bg-color': 'rgba(5, 5, 5, 0.8)',
              } as React.CSSProperties
            }
          />
          <div className="flex items-center backdrop-blur-2xl rounded-2xl p-1.5 pl-2 pr-3">
            <NavItem
