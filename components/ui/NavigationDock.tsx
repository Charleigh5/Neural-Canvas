...
import { 
    Grid, Play, Layers, Camera, Hexagon
} from 'lucide-react';
...
export const NavigationDock = () => {
    ...
    const NavItem = ({ 
        ...
        return (
            ...
            >
                <Icon size={20} strokeWidth={isActive ? 2.5 : 2} className="relative z-10 transition-transform duration-300 group-hover:scale-110" />
                
                <span className={`absolute bottom-1 text-[7px] font-black uppercase tracking-wider transition-all duration-300 ${isActive ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-1'}`}>
                    {label}
                </span>
    ...
    return (
        <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-[200] flex items-center gap-6">
            ...
            <div className="relative z-30">
                ...
                >
                    ...
                    <div className={`absolute inset-0 rounded-full blur-xl transition-all duration-500 ${
                        mode === AppMode.HOME ? 'bg-indigo-600/40 scale-125' : 'bg-white/0 group-hover:bg-indigo-600/20'
                    }`} />
