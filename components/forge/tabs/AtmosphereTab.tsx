...
import { Snowflake, Stars, Sparkles } from 'lucide-react';

interface AtmosphereTabProps {
  onSelect: (mode: 'snow' | 'lights' | 'magic') => void;
}

export const AtmosphereTab: React.FC<AtmosphereTabProps> = ({ onSelect }) => {
  const atmospheres = [
    {
      id: 'snow',
